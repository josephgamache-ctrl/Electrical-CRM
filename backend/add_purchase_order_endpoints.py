#!/usr/bin/env python3
"""Script to add purchase order endpoints to main.py"""

with open('main.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Find the location to insert before vendor management
insertion_marker = '''# ============================================================
# VENDOR MANAGEMENT
# ============================================================
...
async def create_purchase_order(
    ...
    try:
        ...
        """, (po_data.vendor_id, po_data.notes, current_user.get('username')))
    ...
    try:
        ...
        cur.execute("""
            INSERT INTO purchase_orders (
                ...
                triggered_by_projection, projection_date
            )
            VALUES (%s, 'draft', %s, %s, TRUE, %s)
            RETURNING id, po_number
        """, (
            vendor_id,
...
async def receive_items(
    ...
    try:
        ...
        for item in receive_data.items:
            ...
            new_inv_qty = poi['current_qty'] + qty_received
            cur.execute("UPDATE inventory SET qty = %s WHERE id = %s", (new_inv_qty, poi['inv_id']))
            ...
            """, (
                poi['inv_id'], qty_received, poi['current_qty'], new_inv_qty,
...
if insertion_marker in content:
    ...
    with open('main.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print('Successfully added purchase order endpoints')
else:
